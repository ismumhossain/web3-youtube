...
format :; prettier --write src/**/*.sol && prettier --write src/*.sol && prettier --write script/*.sol && prettier --write test/*.sol
...
deploy-all :; make deploy-${network} contract=Web3Video && make deploy-${network} contract=Web3Video